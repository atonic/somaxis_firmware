...
#define SPI_OPERATING_FREQUENCY  ( 0x02000000UL << (uint32_t)Freq_500Kbps )  /*!< Slave clock frequency. */
...
#define SPI_PSELMOSI0             4   /*!< GPIO pin number for Master Out Slave In    */
#define SPI_PSELMISO0             2   /*!< GPIO pin number for Master In Slave Out    */
#define SPI_PSELSS0               5   /*!< GPIO pin number for Slave Select           */

/*  SPI1 */
// Accel
#define SPI_PSELSCK1              12   /*!< GPIO pin number for SPI clock              */
#define SPI_PSELMOSI1             11   /*!< GPIO pin number for Master Out Slave In    */
#define SPI_PSELMISO1             14   /*!< GPIO pin number for Master In Slave Out    */
#define SPI_PSELSS1               13   /*!< GPIO pin number for Slave Select           */
...
#define TIMEOUT_COUNTER          0x100UL  /*!< timeout for getting rx bytes from slave */
