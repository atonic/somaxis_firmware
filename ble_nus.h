...
#define BLE_UUID_NUS_AFE_DATA_CHARACTERISTIC       0
#define BLE_UUID_NUS_AFE_COMMAND_CHARACTERISTIC    1
#define BLE_UUID_NUS_ACCEL_DATA_CHARACTERISTIC     2
#define BLE_UUID_NUS_ACCEL_COMMAND_CHARACTERISTIC  3
#define BLE_UUID_NUS_DEBUG_DATA_CHARACTERISTIC     4

#define BLE_UUID_NUS_DATA_CHARACTERISTIC 7
#define BLE_UUID_NUS_DATA_tx 8
 
#define NUS_MAX_DATA_LENGTH 200
...
typedef void (*ble_nus_data_handler_t) (ble_nus_t * p_nus, int num, uint8_t * data, uint16_t length);
...
typedef struct ble_nus_s
{
    ...
    ble_gatts_char_handles_t afe_data_handles;
    ble_gatts_char_handles_t afe_command_handles;
    ble_gatts_char_handles_t accel_data_handles;
    ble_gatts_char_handles_t accel_command_handles;
    ble_gatts_char_handles_t debug_data_handles;
    ble_gatts_char_handles_t verison_data_handles;
    ble_gatts_char_handles_t tx_data_handles;
